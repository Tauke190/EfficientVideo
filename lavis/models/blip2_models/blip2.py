...
from lavis.models.residualvit_encoder import create_residualvit_encoder
...
class Blip2Base(BaseModel):
    ...
    def init_vision_encoder(
        ...
        assert model_name in [
            ...
            "clip_L",
            "residualvit",
        ], "vit model must be eva_clip_g, eva2_clip_L, clip_L, or residualvit"
        ...
        elif model_name == "residualvit":
            visual_encoder = create_residualvit_encoder(precision=precision)
